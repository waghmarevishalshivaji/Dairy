  ...
  try {
    ...
    return res.status(200).json({
      ...
      user: {
        ...
        "id": userDetails[0].id,
        "formatted_user_id": userDetails[0].formatted_user_id,
        "dairy_id": userDetails[0].dairy_id,
        "username": userDetails[0].username,
        "fullName": userDetails[0].fullName,
        "is_active": userDetails[0].is_active,
        "password": userDetails[0].password,
        "mobile_number": userDetails[0].mobile_number,
        "email": userDetails[0].email,
        "organization": userDetails[0].organization,
        "bankName": userDetails[0].bankName,
        "accountNumber": userDetails[0].accountNumber,
        "aadhaarCard": userDetails[0].aadhaarCard,
        "panCard": userDetails[0].panCard,
        "ifscCode": userDetails[0].ifscCode,
        "rateChart": userDetails[0].rateChart,
        "milkType": userDetails[0].milkType,
        "role": userDetails[0].role,
        "address": userDetails[0].address,
        "expo_token": userDetails[0].expo_token,
        "confirm": userDetails[0].confirm,
        "is_mobile": userDetails[0].is_mobile,
        "profile_pic": userDetails[0].profile_pic,
        "createby": userDetails[0].createby
      },
      token,
    });
  } catch (err) {
